...
我们在主流的云平台上发布了 [WampServer 镜像](https://apps.websoft9.com/lamp)供用户使用。云平台一般支持三种镜像部署方式：
...
我们在 Github上发布了 [WampServer 自动化部署脚本](https://github.com/Websoft9/ansible-lamp)，脚本基于 Ansible 编写。只要熟悉 Ansible，便可以实现 **无人值守（全自动化）** 的方式将 WampServer 部署到服务器。
