...
This chapter is used for users who have subscribed **VtigerCRM image** or **WampServer image**.
...
If you are using WampServer, please deploy VtigerCRM to your Server as follows:
...
4. Refer to *[Deploy second application](https://support.websoft9.com/docs/lamp/solution-deployment.html#deploy-second-application)* of [WampServer](https://support.websoft9.com/docs/lamp/) to deploy VtigerCRM to your Server
...
Refer to [HTTPS of WampServer](https://support.websoft9.com/docs/lamp/solution-https.html)
