...
Websoft9提供的 **Laravel 运行环境(WampServer)**，基于 [WampServer 环境镜像](https://support.websoft9.com/docs/lamp/zh)制作，节省你的安装部署时间。

### Laravel安装原理

下面介绍Laravel是如何基于WampServer安装的

> 如果您使用 **Laravel 运行环境(WampServer)**，只需了解原理即可，无需再次安装 Laravel。
