...
本文档可供使用了 **EspoCRM 镜像** 用户参考，也可以供准备在 **WampServer 镜像** 上自行部署 EspoCRM 参考。
...
如果你使用的是 WampServer 镜像，请先将 EspoCRM 安装到服务器，操作步骤如下：
...
4. 参考[《如何在 WampServer 上增加网站》](https://support.websoft9.com/docs/lamp/zh/solution-deployment.html#安装第二个网站) ，将 EspoCRM 安装到服务器的 [WampServer](https://support.websoft9.com/docs/lamp/zh/) 环境中
